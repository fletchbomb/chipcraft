...
**Non-canonical systems document.** This file defines how NPCs evaluate and choose legal actions during combat. The canonical GDD remains the only source of truth for combat rules, timing, targeting, shapes, effect resolution, power, statuses, chip behavior, terminology, construction legality, and mode-independent state concepts. This file owns the NPC decision pipeline, legal-action evaluation, projected-resolution scoring, personality weighting, tie-break behavior, controlled randomness, and preview commitment behavior. Mode documents may provide scenario content, encounter context, or currently active content sets, but they do not become source-of-truth parents for AI rule behavior. This file does not replace the GDD. It routes NPC decision-making through those existing systems.
...
- mode documents may supply scenario content or currently active content sets, but they do not redefine AI rule truth
